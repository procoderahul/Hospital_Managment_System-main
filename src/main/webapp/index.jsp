	...
	<section class="py-5 py-xl-8">
		...
		<div class="container overflow-hidden">
            ...
            <path fill-rule="evenodd"
						...
						<p class="m-0 text-secondary">Complete security to the data of the members of our
									family.</p>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-lg-4">
            ...
            <path
						...
						<p class="m-0 text-secondary">Trained Specialists for various kinds of any type of  illness.</p>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-lg-4">
					<div class="text-center px-xl-2">
            ...
            <path
						...
						<p class="m-0 text-secondary">Complete coordination with the patients for their well
									being.</p>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-lg-4">
            ...
            <path
						...
						<p class="m-0 text-secondary">A comprehensive report management of the patients for
            ...
            <path
						...
						<p class="m-0 text-secondary">Security enhancement by verifying the users who are signing in.</p>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-lg-4">
					<div class="text-center px-xl-2">
            ...
            <path
						...
						<p class="m-0 text-secondary">Scheduling of the appointments for the users with doctors responses.</p>
					</div>
				</div>
			</div>
		</div>
